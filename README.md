...
- `mobile-fix-log.md` records the phone, tablet, desktop, accessibility, image, and link audit.
...
- `assets/work/hero-evidence-paths-mobile.webp` is the compressed phone hero asset used below 700px.
